    ...
    public partial class Form1 : Form
    {
        ...
        private void DownSize_Click(object sender, EventArgs e)
        {
            if (pictureBoxOriginal.Image != null)
            {
                ...
                {
                    MessageBox.Show("Enter a valid downscaling percentage (1-100).", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
                ...
                stopwatch.Stop();
                MessageBox.Show($"Non-threaded resizing - {stopwatch.ElapsedMilliseconds} ms.", "Time Measurement");
            }
        }
        private void DownscaleThreads_Click_1(object sender, EventArgs e)
        {
            if (pictureBoxOriginal.Image != null)
            {
                ...
                Thread resizingThread = new Thread(() =>
                {
                    ...
                    stopwatch.Stop(); 
                    MessageBox.Show($"Threaded resizing - {stopwatch.ElapsedMilliseconds} ms.", "Time Measurement");
